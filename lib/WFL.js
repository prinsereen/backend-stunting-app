...
export function getWflData(filePath){
...
export function getZScoreWeightForLength(length, weight, Data) {
...
export const dataWFLBoys02 = getWflData(filePath1)
export const dataWFLBoys25 = getWflData(filePath2)
export const dataWFLGirls02 = getWflData(filePath3)
export const dataWFLGirls25 = getWflData(filePath4)
