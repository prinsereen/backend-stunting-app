...
function getZScoreBMI(Month, BMI, Data) {
...
const dataBMIBoys02 = getBMIData(filePath1)
const dataBMIBoys25 = getBMIData(filePath2)
const dataBMIGirls02 = getBMIData(filePath3)
const dataBMIGirls25 = getBMIData(filePath4)
...
console.log(`Z-Score: ${getZScoreBMI(1, getBMI(length,  weight), dataBMIBoys02)}`);
console.log(`Z-Score: ${getZScoreBMI(25, getBMI(length, weight), dataBMIBoys25)}`);
console.log(`Z-Score: ${getZScoreBMI(1, getBMI(length, weight), dataBMIGirls02)}`);
console.log(`Z-Score: ${getZScoreBMI(25, getBMI(length, weight), dataBMIGirls25)}`);