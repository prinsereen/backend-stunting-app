...
function getZScoreLengthForAge(month, length, Data) {
...
const dataLFABoys02 = getLFAData(filePath1)
const dataLFABoys25 = getLFAData(filePath2)
const dataLFAGirls02 = getLFAData(filePath3)
const dataLFAGirls25 = getLFAData(filePath4)
